...
Clasificador1_train %>% dim # 90 16
Clasificador1_test %>% dim #  22  16
...
Clasificador2_train %>% dim # 90   16
Clasificador2_test %>% dim #  22  16
# CLASIFICADOR
