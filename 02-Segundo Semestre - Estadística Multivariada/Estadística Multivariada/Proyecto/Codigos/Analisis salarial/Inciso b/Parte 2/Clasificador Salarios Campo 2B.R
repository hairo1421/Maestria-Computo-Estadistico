...
Clasificador1_train %>% dim # 102 16
Clasificador1_test %>% dim #  25  16
...
Clasificador2_train %>% dim # 102   16
Clasificador2_test %>% dim #  25  16
# CLASIFICADOR
