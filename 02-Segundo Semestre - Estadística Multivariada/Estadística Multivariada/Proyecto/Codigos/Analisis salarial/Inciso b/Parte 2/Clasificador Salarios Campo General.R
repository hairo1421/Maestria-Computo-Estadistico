...
Clasificador1_train %>% dim # 887   16
Clasificador1_test %>% dim #  222  16
...
Clasificador2_train %>% dim # 887   16
Clasificador2_test %>% dim #  222  16
# CLASIFICADOR
