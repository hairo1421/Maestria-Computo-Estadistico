...
Clasificador1_train %>% dim # 118 16
Clasificador1_test %>% dim #  30  16
...
Clasificador2_train %>% dim # 118   16
Clasificador2_test %>% dim #  30  16
# CLASIFICADOR
