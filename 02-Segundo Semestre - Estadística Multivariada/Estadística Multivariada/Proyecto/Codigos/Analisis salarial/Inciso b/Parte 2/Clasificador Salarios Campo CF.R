...
Clasificador1_train %>% dim # 98 16
Clasificador1_test %>% dim #  24  16
...
Clasificador2_train %>% dim # 98   16
Clasificador2_test %>% dim #  24  16
# CLASIFICADOR
