...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="X2B")
BASE_NOnA %>% dim # 241 117
...
Clasificador1_train %>% dim # 114  22
Clasificador1_test %>% dim # 29 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>.9)
...
Clasificador2_train %>% dim # 107  17
...
temp2 <- SeleccionVariables2 %>% filter(importance>3.8)
# Variables seleccionadas
temp2$variable
#[1] "PA"     "Plays"  "WPA..1" "RE24"  
#[5] "AB.win"  
...
Clasificador3_train %>% dim #  114  12
Clasificador3_test %>% dim # 29  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
Clasificador4_train %>% dim #  107  54
