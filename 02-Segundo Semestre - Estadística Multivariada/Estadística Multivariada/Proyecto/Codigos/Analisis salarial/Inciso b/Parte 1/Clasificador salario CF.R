...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="CF")
BASE_NOnA %>% dim # 196 117
...
Clasificador1_train %>% dim # 106  22
Clasificador1_test %>% dim # 26 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>3)
...
Clasificador2_train %>% dim # 92  17
Clasificador2_test %>% dim # 23 17
...
Clasificador3_train %>% dim #  106  12
Clasificador3_test %>% dim # 26  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp3 <- SeleccionVariables3 %>% filter(importance>5)
# Variables seleccionadas
temp3$variable
...
Clasificador4_train %>% dim #  92  54
Clasificador4_test %>% dim # 23 54
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp4<- SeleccionVariables4 %>% filter(importance>1.1)
# Variables seleccionadas
temp4$variable
# "X2B.bateo" "OPS"       "BtWins"   
# [4] "WPA"       "RE24" 
