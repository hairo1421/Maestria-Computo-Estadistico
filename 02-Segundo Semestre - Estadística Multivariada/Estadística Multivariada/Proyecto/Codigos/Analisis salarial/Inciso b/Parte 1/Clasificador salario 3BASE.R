...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="X3B")
BASE_NOnA %>% dim # 225 117
...
Clasificador1_train %>% dim # 122  22
Clasificador1_test %>% dim # 31 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>1.1)
# Variables seleccionadas
temp1$variable
# [1]"R"   "HR"  "RBI" "BB"  "BA"  "SLG" "GDP"      
...
Clasificador2_train %>% dim # 111  17
Clasificador2_test %>% dim # 28 17
...
temp2 <- SeleccionVariables2 %>% filter(importance>2.5)
# Variables seleccionadas
temp2$variable
#[1] "PHlev"  "AB.win"
...
Clasificador3_train %>% dim #  122  12
Clasificador3_test %>% dim # 31  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp3 <- SeleccionVariables3 %>% filter(importance>2.8)
# Variables seleccionadas
temp3$variable
#  "PA.val" "Rfield" "RAR"    "oRAR"   
...
Clasificador4_train %>% dim #  111  54
Clasificador4_test %>% dim # 28 54
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp4<- SeleccionVariables4 %>% filter(importance>1.2)
# Variables seleccionadas
temp4$variable
# "OBP"    "SF"     "IBB"    "Clutch"
# [5] "PHlev"  "AB.win"
