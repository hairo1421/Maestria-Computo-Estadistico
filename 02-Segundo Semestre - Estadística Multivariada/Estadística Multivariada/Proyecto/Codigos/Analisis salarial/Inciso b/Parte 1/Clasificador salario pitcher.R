...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="P")
...
Clasificador1_train %>% dim # 524  22
Clasificador1_test %>% dim #92 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>5)
# Variables seleccionadas
temp1$variable
#"SO"   "BA"   "OBP"  "SLG"  "OPS"  "OPS."
...
Clasificador2_train %>% dim # 61  17
Clasificador2_test %>% dim #15 17
...
temp2 <- SeleccionVariables2 %>% filter(importance>.75)
# Variables seleccionadas
temp2$variable
#[1] "PA"     "Plays"  "WPA."   "WPA..1" "aLI"   
#[6] "PHlev" 
Clasificador2_tes
# varios modelos
...
Clasificador3_train %>% dim #  911  12
Clasificador3_test %>% dim # 127  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp3 <- SeleccionVariables3 %>% filter(importance>10)
# Variables seleccionadas
temp3$variable
#[1] "G.val"  "PA.val" "Rbat"   "Rpos"    
...
Clasificador4_train %>% dim #  61  12
Clasificador4_test %>% dim # 7  12
...
temp4<- SeleccionVariables4 %>% filter(importance>.2)
# Variables seleccionadas
temp4$variable
#[1] "RBI"       "BB"        "SO"        "OBP"      
#[5] "SLG"       "OPS."      "TB"        "PA.val"   
#[9] "WAR"       "waaWL."    "WPA..1"    "aLI"      
#[13] "RE24.boLI" "PHlev"  
