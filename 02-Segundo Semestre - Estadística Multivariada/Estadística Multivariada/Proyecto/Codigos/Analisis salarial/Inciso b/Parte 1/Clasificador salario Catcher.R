...
Clasificador1_train %>% dim # 162  22
Clasificador1_test %>% dim # 40 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>2)
...
Clasificador2_train %>% dim # 144  17
Clasificador2_test %>% dim # 36 17
...
temp2 <- SeleccionVariables2 %>% filter(importance>2)
# Variables seleccionadas
temp2$variable
# [1] "PA"        "Plays"     "WPA."      "WPA..1"   
#[5] "RE24.boLI" "PHlev"    
...
Clasificador3_train %>% dim #  162  12
Clasificador3_test %>% dim # 40  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp3 <- SeleccionVariables3 %>% filter(importance>3)
# Variables seleccionadas
temp3$variable
#"G.val"  "PA.val" "Rbat"   "oRAR"  
...
Clasificador4_train %>% dim #  144  54
Clasificador4_test %>% dim # 36 54
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp4<- SeleccionVariables4 %>% filter(importance>1.8)
# Variables seleccionadas
temp4$variable
#[1] "SO"        "OBP"       "GDP"       "PA.val"   
#[5] "Plays"     "WPA."      "RE24.boLI" "PHlev"   
