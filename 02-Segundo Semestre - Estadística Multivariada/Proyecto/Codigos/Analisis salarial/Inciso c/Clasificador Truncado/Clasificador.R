...
clasificador1_p1<- ggplot(SeleccionVariables1, aes(x=reorder(variable,importance), y=importance,fill=importance))+ 
  ...
  xlab("")+
  ggtitle("Variables Pitcher Básicas")+
  guides(fill=F)+
...
temp1$variable
#[1] "ERA"   "GS.st" "IP.st" "H"     "R.st" 
#[6] "ER"    "HR"    "BB"    "SO"    "BF"   
#[11] "ERA."  "FIP"   "WHIP"  "H9"    "SO9"  
#[16] "SO.W" 
...
clasificador2_p1<- ggplot(SeleccionVariables2, aes(x=reorder(variable,importance), y=importance,fill=importance))+ 
  ...
  ylab("Variable Importancia")+
  xlab("")+
  ggtitle("Variables Pitcher Valor del jugador")+
  guides(fill=F)+
  scale_fill_gradient(low="red", high="blue")


temp2 <- SeleccionVariables2 %>% filter(importance>5)
# Variables seleccionadas
temp2$variable
#[1] "IP.val" "G.val"  "R.val"  "RA9"   
#[5] "RA9opp" "RA9def" "PPFp"   "RA9avg"
#[9] "gmLI"   "waaWL." 
...
clasificador3_p1<- ggplot(SeleccionVariables3, aes(x=reorder(variable,importance), y=importance,fill=importance))+ 
  ...
  ylab("Variable Importancia")+
  xlab("")+
  ggtitle("Variables Pitcher Probabilidad de Ganar")+
  guides(fill=F)+
  scale_fill_gradient(low="red", high="blue")


temp3 <- SeleccionVariables3 %>% filter(importance>9)
# Variables seleccionadas
temp3$variable
#[1] "IP"        "PtchR"     "Plays"    
#[4] "WPA."      "WPA..1"    "aLI"      
...
clasificador4_p1<- ggplot(SeleccionVariables4, aes(x=reorder(variable,importance), y=importance,fill=importance))+ 
  ...
  ylab("Variable Importancia")+
  xlab("")+
  ggtitle("Variables Pitcher")+
  guides(fill=F)+
  scale_fill_gradient(low="red", high="blue")


temp4 <- SeleccionVariables4 %>% filter(importance>.8)
# Variables seleccionadas
temp4$variable
#[1] "PtchR"     "Plays"     "WPA"      
#[4] "WPA."      "WPA..1"    "aLI"      
#[7] "WPA.LI"    "RE24"      "RE24.boLI"
#[10] "LevHi"     "GS.val"    "R.val"    
#[13] "RA9avg"    "gmLI"      "L"        
#[16] "ERA"       "GF"        "SV"       
#[19] "H"         "HR"        "BB"       
#[22] "SO"        "HBP"       "WP"       
