...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="X1B")
...
Clasificador1_train %>% dim # 121  22
Clasificador1_test %>% dim # 30 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>3.5)
...
Clasificador2_train %>% dim # 108  17
Clasificador2_test %>% dim # 27 17
...
Clasificador3_train %>% dim #  121  12
Clasificador3_test %>% dim # 30  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp3 <- SeleccionVariables3 %>% filter(importance>2.5)
# Variables seleccionadas
temp3$variable
# "G.val"  "PA.val" "Rpos"   "Rrep" 
...
Clasificador4_train %>% dim #  108  54
Clasificador4_test %>% dim # 27 54
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
