...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="SS")
BASE_NOnA %>% dim # 169 117
...
Clasificador1_train %>% dim # 98  22
Clasificador1_test %>% dim # 24 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>.85)
...
Clasificador2_train %>% dim # 77  17
Clasificador2_test %>% dim # 19 17
...
temp2 <- SeleccionVariables2 %>% filter(importance>1.5)
# Variables seleccionadas
temp2$variable
#[1] "PHlev"  "AB.win"
...
Clasificador3_train %>% dim #  98  12
Clasificador3_test %>% dim # 24  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp3 <- SeleccionVariables3 %>% filter(importance>4)
# Variables seleccionadas
temp3$variable
# "PA.val" "Rdp"    "Rfield" 
...
Clasificador4_train %>% dim #  77  54
Clasificador4_test %>% dim # 19 54
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
...
temp4<- SeleccionVariables4 %>% filter(importance>.3)
# Variables seleccionadas
temp4$variable
# "RBI"    "GDP"    "WPA.LI" "PHlev" 
