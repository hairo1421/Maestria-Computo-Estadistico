...
BASE_NOnA <- BASE_NOnA %>% filter(Posicion=="LF")
BASE_NOnA %>% dim # 273 117
...
Clasificador1_train %>% dim # 133  22
Clasificador1_test %>% dim # 33 22
...
temp1 <- SeleccionVariables1 %>% filter(importance>1.5)
...
Clasificador2_train %>% dim # 127  17
Clasificador2_test %>% dim # 32 17
...
temp2 <- SeleccionVariables2 %>% filter(importance>4)
# Variables seleccionadas
temp2$variable
#[1] "PA"        "Plays"     "Clutch"   
#[4] "RE24"      "RE24.boLI" "PHlev"    
#[7] "AB.win"   
...
Clasificador3_train %>% dim #  133  12
Clasificador3_test %>% dim # 33  12
# Random Forest
# PARALELIZACIÓN DE PROCESO
#===============================================================================
# RANDOM FOREST
