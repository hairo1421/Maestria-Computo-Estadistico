...
Clasificador1_train %>% dim # 112 16
Clasificador1_test %>% dim #  28  16
...
Clasificador2_train %>% dim # 112   16
Clasificador2_test %>% dim #  28  16
# CLASIFICADOR
