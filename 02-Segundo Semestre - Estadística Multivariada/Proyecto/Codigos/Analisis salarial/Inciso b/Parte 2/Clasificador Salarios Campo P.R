...
# SOLO CON ESTAS VARIABLES SE PUDÓ HACER ALGO
# si le pongo las otras solo tengo 10 casos completos
# VARIABLES BASE CAMPO Estandart
Varibles_campo <- names(BASE_NOnA)[c(85:93)]
...
Clasificador1_train %>% dim # 911   10
Clasificador1_test %>% dim #  228  10
...
temp1 <- SeleccionVariables1 %>% filter(importance>15)
# Variables seleccionadas
temp1$variable
#"G.st.campo" "GS.st"      "Inn"       
# [4] "Ch"         "PO"         "A"  
...
# SSOLO CON ESTAS VARIABLES SE PUDÓ HACER ALGO
# si le pongo las otras solo tengo 10 casos completos
# VARIABLES BASE CAMPO Estandart
Varibles_campo <- names(BASE_NOnA)[c(85:93)]
Varibles_campo <- c(Varibles_campo,names(BASE_NOnA)[117])
...
Clasificador2_train %>% dim # 911   16
Clasificador2_test %>% dim #  228  16
# CLASIFICADOR
