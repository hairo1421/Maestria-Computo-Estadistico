...
Clasificador1_train %>% dim # 103 16
Clasificador1_test %>% dim #  26  16
...
Clasificador2_train %>% dim # 103   16
Clasificador2_test %>% dim #  26  16
# CLASIFICADOR
